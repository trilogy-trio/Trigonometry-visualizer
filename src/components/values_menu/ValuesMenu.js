...
function ValuesMenu(props) {
  return (
    <Menu right noOverlay disableAutoFocus isOpen width={375}>
        ...
        NOTE: Trigonometric values are rendered on the circle as their absolute value and rounded to two decimal places, consult the values below for better accuracy.
      </label>
